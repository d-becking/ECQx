...
class MergeBatchNorm(Canonizer):
    ...
    @staticmethod
    def merge_batch_norm_(modules, batch_norm):
    ...
    def merge_batch_norm(modules, batch_norm):
        '''Update parameters of Batch Normalization Layer to represent linear Layer by changing weight and bias to
        include running mean and running var.
        ...
        # change batch_norm parameters to produce identity
        batch_norm.bias.data = batch_norm.bias - batch_norm.running_mean * scale
        batch_norm.weight.data = scale
        batch_norm.running_mean.data = torch.zeros_like(batch_norm.running_mean.data)
        batch_norm.running_var.data = torch.ones_like(batch_norm.running_var.data) - batch_norm.eps
