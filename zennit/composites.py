...
import torch
from models.ResNet_CIFAR import LambdaLayer
...
class LayerMapComposite(Composite):
    ...
    '''
    def __init__(self, layer_map, canonizers=None, weight_rule=None):
        self.layer_map = layer_map
        super().__init__(self.mapping, canonizers=canonizers, weight_rule=weight_rule)
...
class SpecialFirstLayerMapComposite(LayerMapComposite):
    ...
    '''
    def __init__(self, layer_map, first_map, canonizers=None, weight_rule=None):
        self.first_map = first_map
        self.weight_rule = weight_rule
        super().__init__(layer_map, canonizers=canonizers, weight_rule=weight_rule)
...
class NameMapComposite(Composite):
    ...
    '''
    def __init__(self, name_map, canonizers=None, weight_rule=None):
...
class EpsilonFlat(SpecialFirstLayerMapComposite):
    ...
    def __init__(self, canonizers=None, weight_rule=None):
        ...
        super().__init__(layer_map, first_map, weight_rule=weight_rule, canonizers=canonizers)


@register_composite('epsilon_flat_bn')
class EpsilonFlatBN(SpecialFirstLayerMapComposite):

    def __init__(self, canonizers=None, weight_rule=None):
        layer_map = LAYER_MAP_BASE + [
            (Convolution, GammaBnConv(0.05)),
            (BatchNorm, GammaAdapt(0.1)),
            (torch.nn.Linear, Epsilon()),
        ]
        first_map = [
            (Linear, Flat())
...
class EpsilonGammaFlat(SpecialFirstLayerMapComposite):
    ...
    def __init__(self, canonizers=None, weight_rule=None):
        ...
        super().__init__(layer_map, first_map, canonizers=canonizers, weight_rule=weight_rule)


@register_composite('epsilon_gamma_flat_bn')
class EpsilonGammaFlatBN(SpecialFirstLayerMapComposite):

    def __init__(self, canonizers=None, weight_rule=None):
        layer_map = LAYER_MAP_BASE + [
            (Convolution, GammaAdapt(0.25)),
            (BatchNorm, GammaAdapt(0.25)),
            (torch.nn.Linear, Epsilon()),
        ]
        first_map = [
            (Linear, Flat())
...
@register_composite('epsilon_gamma_flat_bn_pass')
class EpsilonGammaFlatBN(SpecialFirstLayerMapComposite):
...
class EpsilonAlpha2Beta1(LayerMapComposite):
    ...
    def __init__(self, canonizers=None, weight_rule=None):
        layer_map = LAYER_MAP_BASE + [
            ...
            (BatchNorm, AlphaBeta(alpha=2, beta=1)),
            (torch.nn.Linear, Epsilon()),
        ]
        super().__init__(layer_map, canonizers=canonizers, weight_rule=weight_rule)
...
@register_composite('epsilon_plus_flat_bn_pass')
class EpsilonPlusFlat(SpecialFirstLayerMapComposite):
    '''
    '''
    def __init__(self, canonizers=None, weight_rule=None):
...
@register_composite('alpha2_beta1_flat_bn_pass')
class EpsilonAlpha2Beta1Flat(SpecialFirstLayerMapComposite):
    '''
    '''
    def __init__(self, canonizers=None, weight_rule=None):
